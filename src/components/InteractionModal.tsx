...
const InteractionModal: React.FC<InteractionModalProps> = ({
    ...
    const { gameState, actions, activePlayers } = gameHook;
    ...
    }, [interaction, gameState.players, activePlayers]);
    ...
    }, [interaction, gameState.players, gameState.lastWinnerId, bootAmount, selectedPlayerId, addPlayerName, addPlayerBalance, reorderablePlayers, deductAmount, activePlayers, tempData, actions, onClose, openModal]);
    ...
    return (
        <div className="modal-overlay">
            <div className="modal-container">
                <div className={`modal-header theme-${modalContent?.theme}`}>
                    {modalContent?.icon && <div className="modal-icon">{modalContent.icon}</div>}
                ...
                <div className="modal-footer">{modalContent?.footer}</div>
            </div>
        </div>
    );
};
